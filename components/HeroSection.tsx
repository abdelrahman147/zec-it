                    ...
                    <div className="bg-[#141414] rounded-[16px] md:rounded-[24px] overflow-hidden min-h-[400px] md:min-h-[500px] flex flex-col md:flex-row relative">
                        <div className="hidden md:flex flex-col w-64 p-6 border-r border-white/5 bg-[#141414]">
                            <div className="space-y-6 mt-8">
                                ...
                                <div className="flex items-center gap-3 text-gray-500 px-4 py-2"><Activity size={20} /> Watchlist</div>
                                <div className="flex items-center gap-3 text-gray-500 px-4 py-2"><RefreshCw size={20} /> History</div>
                            </div>
                        </div>
                            ...
                            <div className="relative z-10 flex flex-col gap-4 md:gap-6 max-w-2xl mx-auto mt-8 md:mt-8">
                                ...
                                <div className="bg-[#1a1a1a] p-4 md:p-6 rounded-2xl md:rounded-3xl border border-white/5 flex justify-between items-center">
                                    <div>
                                        ...
                                        <div className="text-2xl md:text-4xl font-bold text-white font-mono">150.00</div>
                                        <span className="text-[10px] md:text-xs text-green-500 mt-1 block">≈ $4,245.50</span>
                                    </div>
                                ...
                                <div className="bg-[#1a1a1a] p-4 md:p-6 rounded-2xl md:rounded-3xl border border-white/5 flex justify-between items-center">
                                    <div>
                                        ...
                                        <div className="text-2xl md:text-4xl font-bold text-white font-mono">2,450.4</div>
